...
const steps = [
  ...
  { id: 1, title: 'Site & Dados', icon: Globe, description: 'Conecte seu site' },
  { id: 2, title: 'Contexto da IA', icon: Upload, description: 'Materiais para IA entender sua solução' },
  { id: 3, title: 'Configuração', icon: Settings, description: 'Revise seu perfil' },
  { id: 4, title: 'Concluído', icon: CheckCircle, description: 'Perfil criado com sucesso' },
];
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-12">
          <div className="text-center space-y-6">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-3xl mx-auto leading-relaxed">
              Crie um perfil que conecta sua solução aos usuários certos no momento perfeito através de IA
            </p>
          </div>
        </div>
      </div>
                      ...
                      <div className="flex-1 h-0.5 mx-4 bg-gradient-to-r from-border to-border">
                        <div 
                          className={`h-full transition-all duration-500 ${
                            isCompleted ? 'bg-gradient-to-r from-primary to-primary-glow' : 'bg-transparent'
                          }`}
                        />
                      </div>
                    )}
