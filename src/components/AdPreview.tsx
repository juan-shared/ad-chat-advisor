...
export const AdPreview = () => {
  ...
  const getPreviewData = () => {
    const baseData = {
      ...
      title: profile.siteData?.title || profile.suggestedPUV || 'Título do seu anúncio',
      description: profile.siteData?.description || 'Descrição do seu produto ou serviço aparecerá aqui',
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center gap-2 text-sm text-muted-foreground">
        ...
        <span>Preview do seu anúncio</span>
        {hasData && (
